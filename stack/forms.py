...
from comments_app.validators import check_valid_mentions


class QuestionForm(forms.ModelForm):
    comment = forms.CharField(validators=[check_valid_mentions],
                              widget=forms.widgets.Textarea,
                              label="Explanation",
                              help_text="Background about your question")
